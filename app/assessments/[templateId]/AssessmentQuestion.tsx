...
export default function AssessmentQuestion({
  ...
  if (question.type === 'CODING') {
    ...
    return (
      <div className="h-[600px] overflow-hidden rounded-xl border border-zinc-200 bg-white md:h-[calc(100dvh-205px)] md:min-h-[520px] md:max-h-none dark:border-slate-800/50 dark:bg-transparent">
        <CodeEditor
          key={question.id}
