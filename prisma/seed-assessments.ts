...
async function seedAssessments() {
  ...
  const pythonQuestions = [
    ...
    },
    {
      ...
      explanation:
        'Un inner join solo mantiene las filas que tienen match en ambos DataFrames.',
    },
    {
      section: 'Python',
      difficulty: 'MID',
    ...
    },
    {
      ...
      options: [
        ...
        {
          id: 'b',
          text: 'cut() usa intervalos iguales, qcut() usa quantiles',
          isCorrect: true,
        },
    ...
    },
    {
      ...
      explanation:
        'pivot_table() convierte de formato largo a ancho. melt() hace lo contrario.',
    },
  ];
  ...
  const sasQuestions = [
    {
      ...
      tags: ['merge', 'sql'],
      questionText:
        'En SAS, ¿cuál es la diferencia entre un DATA step merge y PROC SQL join?',
      options: [
    ...
    },
    {
      ...
      explanation:
        'FORMAT en un DATA step aplica el formato de forma permanente al dataset.',
    },
    {
      section: 'SAS',
      difficulty: 'SENIOR',
    ...
    },
    {
      ...
      explanation:
        'Un IF sin THEN implícitamente hace output solo cuando es verdadero.',
    },
    {
      section: 'SAS',
      difficulty: 'MID',
...
`,
      inputFiles: [
        ...
        },
        {
          ...
          preview:
            'customer_id,age,income,credit_score,region\nC001,35,45000,720,CDMX',
        },
        {
          name: 'payments.csv',
          url: 's3://assessment-data/payments.csv',
          preview:
            'payment_id,loan_id,payment_date,amount_paid,days_late\nP001,L001,2023-02-15,2500,0',
        },
      ],
      testCases: [
        {
        ...
        },
        {
          ...
          points: 20,
          expectedBehavior: 'Crea total_paid, max_days_late, payment_rate, loan_to_income_ratio',
        },
        {
          ...
          points: 25,
          expectedBehavior:
            'Segmenta correctamente en LOW/MEDIUM/HIGH y calcula métricas',
        },
      ],
      language: 'python',
