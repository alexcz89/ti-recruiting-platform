          ...
          <div className="flex flex-col items-center pt-16 pb-16 text-center sm:pt-20 lg:pt-28 lg:pb-20">
            ...
            <div className="mt-10 w-full max-w-lg animate-fade-in-up animation-delay-300">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href="/unete"
                  className="group relative flex flex-1 flex-col items-center gap-1 rounded-2xl bg-emerald-600 dark:bg-emerald-600 px-6 py-4 text-white dark:text-white shadow-xl shadow-emerald-600/20 dark:shadow-emerald-600/40 transition-all duration-200 hover:bg-emerald-500 dark:hover:bg-emerald-500 hover:shadow-2xl hover:shadow-emerald-600/30 hover:-translate-y-0.5 active:translate-y-0"
                >
                  <div className="flex items-center gap-2 font-bold text-base text-white dark:text-white">
                    <UserCircle className="h-5 w-5" />
                    Soy candidato
                    <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                  </div>
                  <span className="text-xs text-emerald-50 dark:text-emerald-50 font-normal">Crea tu perfil, es gratis</span>
                </Link>
