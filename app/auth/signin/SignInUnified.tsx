  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative grid min-h-screen grid-cols-1 lg:grid-cols-2">
        {/* Lado izquierdo */}
        <div className="flex px-6 py-8 lg:px-12 lg:py-12 xl:px-20">
          <div className="flex w-full items-center">
            <div className="w-full space-y-6 sm:space-y-8 lg:space-y-10">
              <div>
                <h1 className="max-w-[12ch] text-4xl font-black leading-tight tracking-tight text-zinc-900 dark:text-zinc-50 sm:text-5xl lg:text-6xl lg:leading-[1.05]">
        ...
        {/* Lado derecho */}
        <div className="flex items-center justify-center px-6 pb-8 pt-2 lg:px-12 lg:py-12">
          <div className="w-full max-w-md">
            {/* Toggle Candidato / Reclutador */}
            <div className="mb-6 grid w-full grid-cols-2 gap-2 rounded-2xl border-2 border-zinc-200 bg-zinc-100/90 p-1.5 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/90 sm:mb-8">
              <button
                type="button"
