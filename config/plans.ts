...
export const PLANS: PlanConfig[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      "20 créditos/mes — 20 evaluaciones MCQ o 4 de código",
      "Bolsa de empleo TI pública",
      "Sin evaluaciones de código (disponible en planes de pago)",
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      "150 créditos/mes — MCQ y evaluaciones de código incluidas",
      "Packs adicionales disponibles desde $249 MXN",
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      "15 vacantes activas",
      "Candidatos ilimitados",
      "500 créditos/mes — MCQ y evaluaciones de código",
      "Packs adicionales con 33% de descuento vs. plan Gratis",
      "Branding de empresa (logo en bolsa pública)",
      "AI Match: todos los candidatos, sin límite",
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      "Vacantes ilimitadas",
      "Candidatos ilimitados",
      "2,000 créditos/mes — escala sin fricción",
      "Packs adicionales con 50% de descuento vs. plan Gratis",
      "Hasta 10 clientes (modo agencia multi-empresa)",
      "15 reclutadores incluidos",
      "AI Match ilimitado + acceso anticipado a nuevas features",
      "Soporte dedicado — SLA garantizado por WhatsApp",
    ],
