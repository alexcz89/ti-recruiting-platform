...
export const PLANS: PlanConfig[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      "150 evaluaciones técnicas incluidas (MCQ + código)",
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      "500 evaluaciones técnicas incluidas (MCQ + código)",
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      "2,000 evaluaciones técnicas incluidas",
